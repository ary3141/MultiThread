...
def main():  # Fungsi utama
    ...
    server_socket.bind(('0.0.0.0', 9999))  # Ikat socket ke IP 0.0.0.0 dan port 9999
    server_socket.listen(5)  # Bikin socket siap dengerin koneksi masuk, maksimal 5 antrian
    ...
    while True:  # Loop buat nerima koneksi klien
        ...
        client_handler = threading.Thread(target=handle_request, args=(client_socket,))  # Bikin thread baru buat ngurusin permintaan klien
        client_handler.start()  # Mulai thread baru
